...
namespace BuildingSurveillanceSystemApplication
{
    ...
    public abstract class Observer : IObserver<ExternalVisitor>
    {
        ...
        IDisposable _cancellation = null;
    ...
    public class EmployeeNotify : Observer
        {
            ...
            public override void OnCompleted()
            {
                ...
                foreach (var externalVisitor in _externalVisitors)
                {
                    ...
                    Console.WriteLine($"{externalVisitor.Id.ToString().PadRight(6)}{externalVisitor.FirstName,-15}{externalVisitor.LastName,-15}{externalVisitor.EntryDateTime.ToString("dd MMM yyyy hh:mm:ss"),-25}{externalVisitor.ExitDateTime.ToString("dd MMM yyyy hh:mm:ss tt"),-25}");
                }
                Console.WriteLine();
                Console.WriteLine();
            }
            ...
            public override void OnNext(ExternalVisitor value)
            {
                ...
                {
                    var externalVisistorListItem = _externalVisitors.FirstOrDefault(e => e.Id == externalVisitor.Id);
